...
const addTaxInvoiceController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const invoice = yield __1.prismaClient.$transaction((prisma) => __awaiter(void 0, void 0, void 0, function* () {
            var _a;
            const invoiceId = taxInvoiceData.invoiceId ? taxInvoiceData.invoiceId : yield (0, generateTaxInvoiceID_1.generateTaxInvoiceID)(prisma);
            const createdInvoice = yield prisma.taxInvoice.create({
                data: Object.assign(Object.assign({}, taxInvoiceData), { invoiceId, createdBy: req.user.userId, invoiceItem: {
                        create: ((_a = taxInvoiceData.invoiceItem) === null || _a === void 0 ? void 0 : _a.map((_a) => {
                            var item = __rest(_a, []);
                            return item;
                        })) || [],
                    } }),
