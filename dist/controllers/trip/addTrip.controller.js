...
const generateTripID_1 = require("../../utils/generateTripID");
const addTrip = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const result = yield __1.prismaClient.$transaction((prisma) => __awaiter(void 0, void 0, void 0, function* () {
            const newTrip = yield addTripHandler(prisma, tripDetails, req.user.userId);
            return newTrip;
        }));
...
const addTripHandler = (prisma, tripDetails, userId) => __awaiter(void 0, void 0, void 0, function* () {
    return yield prisma.tripRecords.create({
        data: Object.assign(Object.assign({}, tripDetails), { tripId: tripDetails.tripId ? tripDetails.tripId : yield (0, generateTripID_1.generateTripID)(prisma), createdBy: userId }),
    });
});
