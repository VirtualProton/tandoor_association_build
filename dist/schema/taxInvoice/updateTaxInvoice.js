...
exports.TaxInvoicePartialUpdateSchema = zod_1.z.object({
    ...
    billingAddress: zod_1.z.string().max(225).optional(),
    shippingAddress: zod_1.z.string().max(225).optional(),
    eWayNumber: zod_1.z.string().max(50).optional(),
    phoneNumber: zod_1.z.string().max(12).optional(),
