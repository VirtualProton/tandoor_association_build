...
vehicleRoutes.get('/search_vehicles/:id', authenticateToken_1.authenticateToken, (0, error_handler_1.errorHandler)(getVehicleDetails_1.getVehicleByIdOrVehicleNumber));
...
getVehicleDetails_1.getVehicleByIdOrVehicleNumber;
