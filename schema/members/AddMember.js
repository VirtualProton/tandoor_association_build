...
const BusinessType = zod_1.z.enum(["OWN_BUSINESS", "FACTORY_ON_LEASE"]);
const AttachmentType = zod_1.z.enum(["SALE_DEED", "ELECTRICITY_BILL", "RENTAL_DEED", "PARTNERSHIP_DEED", "PHOTOS", "DOCUMENTS"]);
