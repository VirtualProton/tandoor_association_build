/*
  ...
  - Added the required column `leaseHolderName` to the `LeaseQueryHistory` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE `LeaseQueryHistory` ADD COLUMN `leaseHolderName` VARCHAR(50) NOT NULL,
    MODIFY `membershipId` VARCHAR(225) NULL,
    MODIFY `fromDate` DATETIME NOT NULL,
