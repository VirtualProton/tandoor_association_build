...
-- AlterTable
ALTER TABLE `compliance_details` ADD COLUMN `factoryLicenseExpiredAt` DATETIME NULL,
    ADD COLUMN `gstExpiredAt` DATETIME NULL,
    ADD COLUMN `mdlExpiredAt` DATETIME NULL,
    ADD COLUMN `tspcbExpiredAt` DATETIME NULL,
    ADD COLUMN `udyamCertificateExpiredAt` DATETIME NULL;
