/*
  ...
  - You are about to alter the column `labourStatus` on the `labours` table. The data in that column could be lost. The data in that column will be cast from `Enum(EnumId(23))` to `Enum(EnumId(17))`.
...
*/
-- AlterTable
ALTER TABLE `labours` MODIFY `labourStatus` ENUM('ACTIVE', 'INACTIVE') NOT NULL DEFAULT 'ACTIVE';
