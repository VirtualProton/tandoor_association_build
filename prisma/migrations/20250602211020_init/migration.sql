/*
  ...
  - Added the required column `note` to the `labours_pending_changes` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE `labours_pending_changes` ADD COLUMN `note` VARCHAR(191) NOT NULL;
