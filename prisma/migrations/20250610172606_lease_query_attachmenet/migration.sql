/*
  ...
  - Added the required column `membershipId` to the `lease_query_attachments` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `lease_query_attachments` ADD COLUMN `membershipId` VARCHAR(225) NOT NULL;
